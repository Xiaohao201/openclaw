...
const BARE_SESSION_RESET_PROMPT_BASE =
  "A new session was started via /new or /reset. Execute your Session Startup sequence now - read the required files before responding to the user. Then greet the user in the configured persona. Keep it to 1-3 sentences and ask what they want to do. Do not mention models, internal steps, files, tools, or reasoning.";
